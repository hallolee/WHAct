    ...
    // CommonJS
     ...
     _IDValidator.prototype = {
         ...
         ,getInfo:function(id){
             ...
             info.birthy = ( code.type === 18 ? birth.slice(0,4) : '19'+birth.slice(0,2) );
             info.birthm = ( code.type === 18 ? birth.slice(4,6) : birth.slice(2,4) );
             info.birthd = ( code.type === 18 ? birth.slice(-2) : birth.slice(-2) );
