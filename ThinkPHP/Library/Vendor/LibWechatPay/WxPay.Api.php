...
class WxPayApi
{
	...
	/**
	 * Get necessary parameters for app in pay
	 * @param array $UnifiedOrderResult
	 * @return array
     * david add @20180418 16:53
	 */
    public static function GetAppParameters( $UnifiedOrderResult )
    {
        if(
            !isset( $UnifiedOrderResult['appid'] ) ||
            !isset( $UnifiedOrderResult['prepay_id'] ) ||
        ...
        $timeStamp = time();
        $app->SetTimeStamp( (string)$timeStamp );
        $app->SetSign();
