...
static public $yy_action = array(
 ...
 /*  22 */ "newline ::= COMMENTSTART NAKED_STRING NEWLINE",
        ...
        do {
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    $nextstate = $this->yy_find_reduc14tion(
   ...
   function yy_find_shift_action($iLookAhead)
    ...
    function yy_find_reduc14tion($stateno, $iLookAhead)
    {
        /* $stateno = $this->yystack[$this->yyidx]->stateno; */
...
#line 752 "smarty_internal_configfileparser.php"
    ...
    function yy_reduce($yyruleno)
    {
        ...
        $yyact = $this->yy_find_reduc14tion($this->yystack[$this->yyidx]->stateno, $yygoto);
